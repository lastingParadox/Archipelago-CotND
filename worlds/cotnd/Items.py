...
armors: list[RawCotNDItemData] = [
    ...
    RawCotNDItemData("Glass Armor", ItemClassification.useful, ItemType.ARMOR, "ArmorGlass", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Heavy Glass Armor", ItemClassification.useful, ItemType.ARMOR, "ArmorHeavyglass", DLC.AMPLIFIED,
                     DefaultType.NEVER),
...
traps: list[RawCotNDItemData] = [
    ...
    RawCotNDItemData("Haunted Shopkeeper Trap", ItemClassification.trap, ItemType.TRAP, "HauntedShopkeeperTrap",
                     DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Hot Coals Trap", ItemClassification.trap, ItemType.TRAP, "BurnTrap", DLC.BASE,
                     DefaultType.NEVER),
    ...
    RawCotNDItemData("Spotlight Trap", ItemClassification.trap, ItemType.TRAP, "SpotlightTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Summon Trap", ItemClassification.trap, ItemType.TRAP, "SummonTrap", DLC.BASE,
                     DefaultType.NEVER),
...
buffs: list[RawCotNDItemData] = [
    RawCotNDItemData("Cadence Buff", ItemClassification.useful, ItemType.BUFF, "APCadenceBuff", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Melody Buff", ItemClassification.useful, ItemType.BUFF, "APMelodyBuff", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Aria Buff", ItemClassification.useful, ItemType.BUFF, "APAriaBuff", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Dorian Buff", ItemClassification.useful, ItemType.BUFF, "APDorianBuff", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Eli Buff", ItemClassification.useful, ItemType.BUFF, "APEliBuff", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Monk Buff", ItemClassification.useful, ItemType.BUFF, "APMonkBuff", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Dove Buff", ItemClassification.useful, ItemType.BUFF, "APDoveBuff", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Coda Buff", ItemClassification.useful, ItemType.BUFF, "APCodaBuff", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Bolt Buff", ItemClassification.useful, ItemType.BUFF, "APBoltBuff", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Bard Buff", ItemClassification.useful, ItemType.BUFF, "APBardBuff", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Nocturna Buff", ItemClassification.useful, ItemType.BUFF, "APNocturnaBuff", DLC.AMPLIFIED, DefaultType.NEVER),
    RawCotNDItemData("Diamond Buff", ItemClassification.useful, ItemType.BUFF, "APDiamondBuff", DLC.AMPLIFIED, DefaultType.NEVER),
    RawCotNDItemData("Mary Buff", ItemClassification.useful, ItemType.BUFF, "APMaryBuff", DLC.AMPLIFIED, DefaultType.NEVER),
    RawCotNDItemData("Tempo Buff", ItemClassification.useful, ItemType.BUFF, "APTempoBuff", DLC.AMPLIFIED, DefaultType.NEVER),
    RawCotNDItemData("Reaper Buff", ItemClassification.useful, ItemType.BUFF, "APReaperBuff", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Klarinetta Buff", ItemClassification.useful, ItemType.BUFF, "APKlarinettaBuff", DLC.SYNCHRONY, DefaultType.NEVER),
    RawCotNDItemData("Chaunter Buff", ItemClassification.useful, ItemType.BUFF, "APChaunterBuff", DLC.SYNCHRONY, DefaultType.NEVER),
    RawCotNDItemData("Suzu Buff", ItemClassification.useful, ItemType.BUFF, "APSuzuBuff", DLC.SYNCHRONY, DefaultType.NEVER),
    RawCotNDItemData("Hatsune Miku Buff", ItemClassification.useful, ItemType.BUFF, "APHatsuneMikuBuff", DLC.MIKU, DefaultType.NEVER),
...
TRAP_ITEMS_BY_COTND_ID = {i.cotnd_id: i for i in ALL_ITEMS if i.type == ItemType.TRAP}
