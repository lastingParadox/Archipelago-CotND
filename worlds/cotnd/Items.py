...
npcs: list[RawCotNDItemData] = [
    ...
    RawCotNDItemData("Hintmaster", ItemClassification.useful, ItemType.NPC, "AP_Hintmaster", DLC.BASE, DefaultType.NEVER),
...
traps: list[RawCotNDItemData] = [
    ...
    # from traplink.csv
    RawCotNDItemData("144p Trap", ItemClassification.trap, ItemType.TRAP, "144pTrap", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("AAA Trap", ItemClassification.trap, ItemType.TRAP, "AaaTrap", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Animal Trap", ItemClassification.trap, ItemType.TRAP, "AnimalTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Armadillo Trap", ItemClassification.trap, ItemType.TRAP, "ArmadilloTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Bald Trap", ItemClassification.trap, ItemType.TRAP, "BaldTrap", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Slip Trap", ItemClassification.trap, ItemType.TRAP, "SlipTrap", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Bomb Trap", ItemClassification.trap, ItemType.TRAP, "BombTrap", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Bonk Trap", ItemClassification.trap, ItemType.TRAP, "BonkTrap", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Freeze Trap", ItemClassification.trap, ItemType.TRAP, "FreezeTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Burn Trap", ItemClassification.trap, ItemType.TRAP, "BurnTrap", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Beetle Trap", ItemClassification.trap, ItemType.TRAP, "BeetleTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Chaos Trap", ItemClassification.trap, ItemType.TRAP, "ChaosTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Cutscene Trap", ItemClassification.trap, ItemType.TRAP, "CutsceneTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Damage Trap", ItemClassification.trap, ItemType.TRAP, "DamageTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Isometric Trap", ItemClassification.trap, ItemType.TRAP, "IsometricTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Disarm Trap", ItemClassification.trap, ItemType.TRAP, "DisarmTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Disable Trap", ItemClassification.trap, ItemType.TRAP, "DisableTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Double Damage Trap", ItemClassification.trap, ItemType.TRAP, "DoubleDamageTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Cursed Trap", ItemClassification.trap, ItemType.TRAP, "CursedTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Exposition Trap", ItemClassification.trap, ItemType.TRAP, "ExpositionTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Fake Transition Trap", ItemClassification.trap, ItemType.TRAP, "FakeTransitionTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Fast Trap", ItemClassification.trap, ItemType.TRAP, "FastTrap", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Flip Horizontal Trap", ItemClassification.trap, ItemType.TRAP, "FlipHorizontalTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Flip Vertical Trap", ItemClassification.trap, ItemType.TRAP, "FlipVerticalTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Frame Slime Trap", ItemClassification.trap, ItemType.TRAP, "FrameSlimeTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Transmute Trap", ItemClassification.trap, ItemType.TRAP, "TransmuteTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Timer Trap", ItemClassification.trap, ItemType.TRAP, "TimerTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Slime Player Trap", ItemClassification.trap, ItemType.TRAP, "SlimePlayerTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Ice Floor Trap", ItemClassification.trap, ItemType.TRAP, "IceFloorTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Help Trap", ItemClassification.trap, ItemType.TRAP, "HelpTrap", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Hiccup Trap", ItemClassification.trap, ItemType.TRAP, "HiccupTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Home Trap", ItemClassification.trap, ItemType.TRAP, "HomeTrap", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Tar Trap", ItemClassification.trap, ItemType.TRAP, "TarTrap", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Instant Death Trap", ItemClassification.trap, ItemType.TRAP, "InstantDeathTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Invisible Trap", ItemClassification.trap, ItemType.TRAP, "InvisibleTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Slow Trap", ItemClassification.trap, ItemType.TRAP, "SlowTrap", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Jump Trap", ItemClassification.trap, ItemType.TRAP, "JumpTrap", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Laughter Trap", ItemClassification.trap, ItemType.TRAP, "LaughterTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Market Crash Trap", ItemClassification.trap, ItemType.TRAP, "MarketCrashTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Meteor Trap", ItemClassification.trap, ItemType.TRAP, "MeteorTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("My Turn Trap", ItemClassification.trap, ItemType.TRAP, "MyTurnTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Commando Trap", ItemClassification.trap, ItemType.TRAP, "CommandoTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Satiated Trap", ItemClassification.trap, ItemType.TRAP, "SatiatedTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("No Revivals Trap", ItemClassification.trap, ItemType.TRAP, "NoRevivalsTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("One Hit Trap", ItemClassification.trap, ItemType.TRAP, "OneHitTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Paper Trap", ItemClassification.trap, ItemType.TRAP, "PaperTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Person Trap", ItemClassification.trap, ItemType.TRAP, "PersonTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Shrink Trap", ItemClassification.trap, ItemType.TRAP, "ShrinkTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Leaping Trap", ItemClassification.trap, ItemType.TRAP, "LeapingTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Earth Trap", ItemClassification.trap, ItemType.TRAP, "EarthTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Shake Trap", ItemClassification.trap, ItemType.TRAP, "ShakeTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Spotlight Trap", ItemClassification.trap, ItemType.TRAP, "SpotlightTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Sticky Hands Trap", ItemClassification.trap, ItemType.TRAP, "StickyHandsTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Stone Trap", ItemClassification.trap, ItemType.TRAP, "StoneTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Swap Trap", ItemClassification.trap, ItemType.TRAP, "SwapTrap", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("Teleport Trap", ItemClassification.trap, ItemType.TRAP, "TeleportTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Tutorial Trap", ItemClassification.trap, ItemType.TRAP, "TutorialTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Undo Trap", ItemClassification.trap, ItemType.TRAP, "UndoTrap", DLC.BASE, DefaultType.NEVER),
    RawCotNDItemData("W I D E Trap", ItemClassification.trap, ItemType.TRAP, "WideTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Zoom In Trap", ItemClassification.trap, ItemType.TRAP, "ZoomInTrap", DLC.BASE,
                     DefaultType.NEVER),
    RawCotNDItemData("Zoom Out Trap", ItemClassification.trap, ItemType.TRAP, "ZoomOutTrap", DLC.BASE,
                     DefaultType.NEVER),
]
